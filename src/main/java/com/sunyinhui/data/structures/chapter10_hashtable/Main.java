package com.sunyinhui.data.structures.chapter10_hashtable;

import com.sunyinhui.data.structures.chapter10_hashtable.Times.Task;
import com.sunyinhui.data.structures.chapter10_hashtable.file.FileInfo;
import com.sunyinhui.data.structures.chapter10_hashtable.file.Files;
...
import com.sunyinhui.data.structures.chapter10_hashtable.map.Map.Visitor;
import com.sunyinhui.data.structures.chapter10_hashtable.map.TreeMap;
import com.sunyinhui.data.structures.chapter10_hashtable.model.Key;
import com.sunyinhui.data.structures.chapter10_hashtable.model.SubKey1;
import com.sunyinhui.data.structures.chapter10_hashtable.model.SubKey2;

public class Main {
	
	static void test1Map(final Map<String, Integer> map, final String[] words) {
	...
	static void test1() {
		String filepath = "/Users/sunyinhui/jdk1.8.0_131/src/java/util/concurrent";
