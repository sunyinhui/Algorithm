package com.sunyinhui.data.algorithm.chapter03_graph;

import com.sunyinhui.data.algorithm.chapter03_graph.graph.Graph;
import com.sunyinhui.data.algorithm.chapter03_graph.graph.Graph.EdgeInfo;
import com.sunyinhui.data.algorithm.chapter03_graph.graph.Graph.PathInfo;
import com.sunyinhui.data.algorithm.chapter03_graph.graph.Graph.WeightManager;
import com.sunyinhui.data.algorithm.chapter03_graph.graph.ListGraph;
...
public class Main {
	static Graph.WeightManager<Double> weightManager = new WeightManager<Double>() {
